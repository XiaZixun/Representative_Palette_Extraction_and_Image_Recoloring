...
public:
	...
	vec3 VertexForeceInside(int const vid,vec3 const &x);
	...
	void ExportLayers(string const &path);
	void ExportLayer(int const k,string const &path);
